...
import com.rizki.mufrizal.aplikasi.absensi.domain.AbsensiHari;
...
public interface AbsensiHariRepository extends PagingAndSortingRepository<AbsensiHari, String> {

    @PreAuthorize("hasRole('ROLE_USER')")
    @Override
    public Page<AbsensiHari> findAll(Pageable pgbl);
